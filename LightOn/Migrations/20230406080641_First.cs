...
namespace LightOn.Migrations
{
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TransformerMeasurements",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentLoad = table.Column<float>(type: "real", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TransformerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransformerMeasurements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransformerMeasurements_Transformers_TransformerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Buildings_Transformers_TransformerId",
                        column: x => x.TransformerId,
                        principalTable: "Transformers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplianceUsageHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplianceUsageHistories_Appliances_ApplianceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplianceUsageHistories_ApplianceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_TransformerId",
                table: "Buildings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransformerMeasurements_TransformerId",
                table: "TransformerMeasurements",
                column: "TransformerId");
        }
