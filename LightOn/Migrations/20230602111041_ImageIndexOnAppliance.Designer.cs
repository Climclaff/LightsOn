...
namespace LightOn.Migrations
{
    ...
    [Migration("20230602111041_ImageIndexOnAppliance")]
    partial class ImageIndexOnAppliance
    {
            ...
            modelBuilder.Entity("LightOn.Models.ApplianceUsagePlanned", b =>
                {
                    ...
                    b.ToTable("ApplianceUsagePlanneds");
                });
            ...
            modelBuilder.Entity("LightOn.Models.User", b =>
                {
                    b.HasOne("LightOn.Models.Building", "Building")
                        .WithOne("User")
                        .HasForeignKey("LightOn.Models.User", "BuildingId");
